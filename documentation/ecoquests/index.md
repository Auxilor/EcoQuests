...
- **Fully config-driven.** Quests and tasks are plain YAML files you can add, edit, or remove without touching code.
...
- **Effect system support.** Rewards, start effects, and start conditions all use the same effect and condition system as every other eco plugin.

<hr/>

## Where to go next

- **Make your first quest:** [How to make a quest](how-to-make-a-quest) walks you through a quest file end to end.
- **Add tasks:** [How to make a task](how-to-make-a-task) covers the goals players complete.
- **Tune the plugin:** [Plugin config](plugin-config) is the full annotated `config.yml`.